...
import { hkdf, hmacSha256, concatBytes } from "./kdf.js";
import { aesGcmDecrypt, aesGcmEncrypt, deriveAead } from "./aead.js";
...
export interface RatchetState {
  ...
  pn: number;
  /** Skipped message keys: outer key = peer DH pub hex, inner key = msg number. */
